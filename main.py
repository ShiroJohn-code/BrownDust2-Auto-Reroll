...
class GameModel:
    ...
    @property
    def position_a(self): return self.position_a_emu if self.platform == "emulator" else (int(self.position_a_win[0]*self.scale_x), int(self.position_a_win[1]*self.scale_y))
    @property
    def position_b(self): return self.position_b_emu if self.platform == "emulator" else (int(self.position_b_win[0]*self.scale_x), int(self.position_b_win[1]*self.scale_y))
    @property
    def position_c(self): return self.position_c_emu if self.platform == "emulator" else (int(self.position_c_win[0]*self.scale_x), int(self.position_c_win[1]*self.scale_y))
